...
This area keeps release and upgrade information easy to reach without mixing the full historical record into the primary implementation path.

Current package/runtime behavior is documented in the product articles and generated API reference. Release notes and verification records below are preserved for version-specific traceability.
...
- [Repository CHANGELOG](https://github.com/AsiBackbone/AsiBackbone/blob/main/CHANGELOG.md)
