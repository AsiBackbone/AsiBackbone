...
| Acknowledgment | [`AcknowledgmentRequest`](xref:AsiBackbone.Core.Acknowledgments.AcknowledgmentRequest), [`AcknowledgmentResponse`](xref:AsiBackbone.Core.Acknowledgments.AcknowledgmentResponse) | Product acknowledgment request/response primitives. The names describe the request/response protocol and do not create legal protection. |
