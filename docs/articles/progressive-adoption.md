...
| Review the current stable package family before broader adoption | [3.2.0 Release Notes](release-notes-320.md) | Install only the packages required by the selected boundary |
