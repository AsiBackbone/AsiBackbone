...
| Review the current stable package family before broader adoption | [3.2.1 Release Notes](release-notes-321.md) | Install only the packages required by the selected boundary |
