...
| Review the stable package family before broader adoption | [7.0.0 Release Notes](release-notes-700.md) | Install only the packages required by the selected boundary |
