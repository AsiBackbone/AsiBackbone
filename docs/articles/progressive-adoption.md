...
| Review the current stable package family before broader adoption | [5.1.0 Release Notes](release-notes-510.md) | Install only the packages required by the selected boundary |
