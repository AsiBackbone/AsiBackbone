...
/// <summary>
/// Resolves the AsiBackbone decision receipt associated with an NCAT completion handoff.
/// </summary>
/// <remarks>
...
/// </remarks>
public interface INcatDecisionReceiptResolver
{
    /// <summary>
    /// Resolves the decision receipt associated with the supplied decision and correlation identifiers.
    /// </summary>
