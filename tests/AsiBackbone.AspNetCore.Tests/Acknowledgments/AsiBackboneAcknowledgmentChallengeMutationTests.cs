...
public sealed class AsiBackboneAcknowledgmentChallengeMutationTests
{
    ...
    public void DefaultChallengeKeepsTraceAndPolicyMetadataOutOfHostFacingShape()
    {
        ...
        Assert.Equal("trace-123", challenge.AcknowledgmentRequest.TraceId);
        Assert.Equal("v1", challenge.AcknowledgmentRequest.PolicyVersion);
        Assert.Equal("hash-123", challenge.AcknowledgmentRequest.PolicyHash);
    }
    ...
    /// </summary>
    [Fact]
    public void HiddenReasonMessageStillStaysInsideCoreAcknowledgmentRequest()
    {
        var actor = GovernanceActorContext.Human("user-123");
        ...
        Assert.Equal("Do not expose this.", challenge.AcknowledgmentRequest.Message);
    }
    ...
    /// </summary>
    [Fact]
    public void FromAcknowledgmentRequestNormalizesMetadataKeysAndValues()
    {
        var actor = GovernanceActorContext.Human("user-123");
        var decision = GovernanceDecision.RequireAcknowledgment("ack.required", "Acknowledgment required.");
        ...
        var challenge =
            AcknowledgmentChallenge.FromAcknowledgmentRequest(request);
    ...
    /// </summary>
    [Fact]
    public void FromAcknowledgmentRequestUsesEmptyMetadataWhenMetadataIsNullOrEmpty()
    {
        var actor = GovernanceActorContext.Human("user-123");
        var decision = GovernanceDecision.RequireAcknowledgment("ack.required", "Acknowledgment required.");
        var request = AcknowledgmentRequest.FromDecision(
    ...
    /// </summary>
    [Fact]
    public void FromAcknowledgmentRequestIncludesOptionalTraceAndPolicyMetadataWhenEnabled()
    {
        var actor = GovernanceActorContext.Human("user-123");
        var decision = GovernanceDecision.RequireAcknowledgment(
            "ack.required",
        ...
        var challenge =
            AcknowledgmentChallenge.FromAcknowledgmentRequest(request, options);
    ...
    /// </summary>
    [Fact]
    public void FromAcknowledgmentRequestRejectsNullRequest()
    {
        _ = Assert.Throws<ArgumentNullException>(() =>
            AcknowledgmentChallenge.FromAcknowledgmentRequest(null!));
    }
    ...
    /// </summary>
    [Fact]
    public void FromAcknowledgmentRequestRejectsInvalidOptions()
    {
        var actor = GovernanceActorContext.Human("user-123");
        var decision = GovernanceDecision.RequireAcknowledgment("ack.required", "Acknowledgment required.");
        var request = AcknowledgmentRequest.FromDecision(
    ...
    /// </summary>
    [Fact]
    public void ConstructorRejectsNullAcknowledgmentRequest()
    {
        AcknowledgmentRequest request = CreateAcknowledgmentRequest();
    ...
    private static AcknowledgmentRequest CreateAcknowledgmentRequest()
    {
