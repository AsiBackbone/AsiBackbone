...
/// </summary>
public sealed class AcknowledgmentMutationTests
{
    /// <summary>
    /// Tests that the FromDecision method correctly uses the first decision reason and preserves trace policy metadata when creating a AcknowledgmentRequest.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Tests that the acknowledgment creation method correctly uses the responding actor and request handshake boundary when creating a AcknowledgmentResponse.
    /// </summary>
    [Fact]
    public void AcknowledgmentUsesRespondingActorAndRequestHandshakeBoundary()
    {
        ...
        var request = AcknowledgmentRequest.Create(
            ...
            AcknowledgmentRiskLevel.Critical,
