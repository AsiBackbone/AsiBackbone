...
public sealed class CapabilityGrantBoundUseLimitTests
{
    ...
    {
        CanonicalPayload withLimit = CanonicalPayloadBuilder.ForCapabilityGrant(
            CreateGrant(maxUseCount: 1, schemaVersion: GovernanceSchemaVersions.StableArtifactsV2));

        CanonicalPayload withWiderLimit = CanonicalPayloadBuilder.ForCapabilityGrant(
    ...
    {
        CanonicalPayload payload = CanonicalPayloadBuilder.ForCapabilityGrant(
    ...
    public async Task ValidationUsesTheIssuerLimitWhenTheCallerAsksForMore()
    {
        ...
        CapabilityGrant grant = CreateGrant(maxUseCount: 1, schemaVersion: GovernanceSchemaVersions.StableArtifactsV2);
    ...
    {
        var useStore = new RecordingUseStore();
        CapabilityGrant grant = CreateGrant(maxUseCount: 10, schemaVersion: GovernanceSchemaVersions.StableArtifactsV2);
    ...
    private static CapabilityGrant CreateGrant(int? maxUseCount = null, string? schemaVersion = null)
    {
