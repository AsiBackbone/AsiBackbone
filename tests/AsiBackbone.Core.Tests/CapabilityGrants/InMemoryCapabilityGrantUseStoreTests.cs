...
public sealed class InMemoryCapabilityGrantUseStoreTests
{
    ...
    {
        SignedGovernanceArtifact<CapabilityGrant> signedGrant = CreateSignedGrant(CreateGrant("grant-replay"));
    ...
    {
        var store = new InMemoryCapabilityGrantUseStore();
        CapabilityGrant firstGrant = CreateGrant("grant-a");
        CapabilityGrant secondGrant = CreateGrant("grant-b");
    ...
    {
        var store = new InMemoryCapabilityGrantUseStore();
        CapabilityGrant stoppedGrant = CreateGrant("grant-stopped");
        CapabilityGrant cancelledGrant = CreateGrant("grant-cancelled");
    ...
    private static CapabilityGrant CreateGrant(string tokenId)
    {
