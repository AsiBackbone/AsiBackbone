...
public sealed class CapabilityGrantValidationProfileTests
{
    ...
    {
        SignedGovernanceArtifact<CapabilityGrant> signedGrant = CreateSignedGrant(CreateGrant());
        ...
        Assert.Equal(CapabilityGrantValidationCategory.MissingProof, result.Category);
    ...
    public async Task ExecutionBoundaryProfileDefersWithoutUseStoreAfterProofPasses()
    {
        ...
        Assert.False(result.ShouldAllow);
        Assert.Equal(CapabilityGrantValidationCategory.ReplayStoreUnavailable, result.Category);
    ...
    public async Task NoOptionsPathDeniesInsteadOfValidatingAgainstNothing()
    {
        ...
        SignedGovernanceArtifact<CapabilityGrant> signedGrant = CreateSignedGrant(grant);
