...
/// <summary>
/// Unit tests for provider-neutral decision receipt telemetry and traceability fields.
/// </summary>
public sealed class DecisionReceiptTelemetryFieldsTests
{
    ...
    public void CreateDefaultsTelemetryFieldsToNullAndUsesStableSchemaVersion()
    {
        ...
        Assert.Equal("event-123", residue.DecisionReceiptId);
    ...
    public void CreateNormalizesAndSerializesTelemetryFields()
    {
        ...
        Assert.Equal("event-123", residue.EventId);
        Assert.Equal("residue-789", residue.DecisionReceiptId);
        ...
        Assert.Equal("residue-789", root.GetProperty("decisionReceiptId").GetString());
    ...
    public void FromDecisionPreservesCorrelationAndCarriesTelemetryFieldsIntoLedgerRecord()
    {
        ...
        Assert.Equal("residue-123", record.DecisionReceiptId);
