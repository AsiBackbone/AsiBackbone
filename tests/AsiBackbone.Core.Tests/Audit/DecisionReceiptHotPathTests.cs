...
/// <summary>
/// Focused tests for allocation-sensitive decision receipt decision-record creation.
/// </summary>
public sealed class DecisionReceiptHotPathTests
{
    /// <summary>
    /// Validates that the <see cref="DecisionReceipt.FromDecision"/> method correctly copies the decision outcome, trace, and reason codes into the resulting decision receipt.
    /// </summary>
    /// <param name="scenario">The scenario under test.</param>
    /// <param name="expectedOutcome">The expected outcome of the decision receipt.</param>
    /// <param name="expectedReasonCode">The expected reason code for the decision receipt.</param>
    [Theory]
