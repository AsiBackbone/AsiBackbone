...
/// <summary>
/// Unit tests for decision receipt lifecycle stages and events.
/// </summary>
public sealed class DecisionReceiptLifecycleEventTests
{
    /// <summary>
    ...
    public void CreateStoresLifecycleStageAndCorrelationFields()
    {
        ...
        Assert.Equal("residue-456", lifecycleEvent.DecisionReceiptId);
        Assert.True(lifecycleEvent.HasDecisionReceiptId);
    ...
    public void FromDecisionReceiptCopiesDecisionContextWithoutRewritingOriginalResidue()
    {
        ...
        Assert.Equal("correlation-123", lifecycleEvent.CorrelationId);
        Assert.Equal("audit-residue-123", lifecycleEvent.DecisionReceiptId);
    ...
    public void LifecycleEventsRepresentPartialProgressAsSeparateEvents()
    {
        ...
        const string decisionReceiptId = "audit-residue-123";
        ...
        Assert.All(lifecycleEvents, lifecycleEvent => Assert.Equal(decisionReceiptId, lifecycleEvent.DecisionReceiptId));
