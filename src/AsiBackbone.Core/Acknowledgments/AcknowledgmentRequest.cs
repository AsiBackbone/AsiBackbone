...
/// </summary>
public sealed class AcknowledgmentRequest
{
    private static readonly IReadOnlyDictionary<string, string> EmptyMetadata =
        new ReadOnlyDictionary<string, string>(
            new Dictionary<string, string>(StringComparer.Ordinal));

    private AcknowledgmentRequest(
        string handshakeId,
    ...
    /// <returns>A acknowledgment request.</returns>
    public static AcknowledgmentRequest Create(
        ...
        string requiredAcknowledgmentCode,
        string requiredAcknowledgmentText,
        AcknowledgmentRiskLevel riskLevel = AcknowledgmentRiskLevel.Unspecified,
    ...
    /// <param name="schemaVersion">Optional schema version for serialized or persisted handshake records.</param>
    /// <returns>A acknowledgment request.</returns>
    public static AcknowledgmentRequest FromDecision(
        IGovernanceActorContext actor,
        string operationName,
