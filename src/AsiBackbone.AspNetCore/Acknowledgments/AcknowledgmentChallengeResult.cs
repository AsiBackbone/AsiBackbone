...
public sealed class AcknowledgmentChallengeResult
{
    ...
    /// </summary>
    public AcknowledgmentResponse? Acknowledgment { get; }
    ...
    /// when the actor explicitly declined, because a refusal is recorded as a <see cref="AcknowledgmentResponse" />
    ...
    public static AcknowledgmentChallengeResult Success(AcknowledgmentResponse acknowledgment)
    {
