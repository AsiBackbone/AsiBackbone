...
/// </summary>
public static class EndpointGovernanceApplicationBuilderExtensions
{
    ...
    /// request is forwarded ungoverned unless <see cref="EndpointGovernanceOptions.RequireGovernanceMetadata" />
        ...
        bool requireEndpointRoutingRegistered = false)
    {
        ...
        return requireEndpointRoutingRegistered && !app.Properties.ContainsKey(EndpointRouteBuilderKey)
            ...
            : app.UseMiddleware<EndpointGovernanceMiddleware>();
    }
}
