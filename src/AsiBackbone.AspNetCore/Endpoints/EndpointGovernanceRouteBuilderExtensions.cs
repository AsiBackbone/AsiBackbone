...
/// </summary>
public static class EndpointGovernanceRouteBuilderExtensions
{
    /// <summary>
    ...
    /// or select constraints from it: the registered <c>IGovernancePolicyEvaluator</c> evaluates every registered
    ...
    /// <see cref="IGovernanceDecisionPolicy{TContext}" /> can read it and vary its own outcome. Marking two endpoints
    ...
    public static RouteHandlerBuilder MarkGovernancePolicy<TPolicy>(this RouteHandlerBuilder builder)
        where TPolicy : IGovernanceDecisionPolicy<GovernanceEvaluationContext>
    {
