...
/// <summary>
/// Configures the Entity Framework Core persistence mapping for <see cref="AuditLedgerRecordEntity" />.
/// </summary>
public sealed class AuditLedgerRecordEntityConfiguration
    : IEntityTypeConfiguration<AuditLedgerRecordEntity>
{
    ...
    /// <inheritdoc />
    public void Configure(EntityTypeBuilder<AuditLedgerRecordEntity> builder)
    {
