...
/// <summary>
/// Configures the Entity Framework Core persistence mapping for <see cref="GovernanceOutboxEntryEntity" />.
/// </summary>
public sealed class GovernanceOutboxEntryEntityConfiguration
    : IEntityTypeConfiguration<GovernanceOutboxEntryEntity>
{
    ...
    /// <inheritdoc />
    public void Configure(EntityTypeBuilder<GovernanceOutboxEntryEntity> builder)
    {
