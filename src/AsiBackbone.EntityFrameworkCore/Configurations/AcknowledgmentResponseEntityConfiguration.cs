...
/// <summary>
/// Configures the Entity Framework Core persistence mapping for <see cref="AcknowledgmentResponseEntity" />.
/// </summary>
public sealed class AcknowledgmentResponseEntityConfiguration
    : IEntityTypeConfiguration<AcknowledgmentResponseEntity>
{
    ...
    /// <inheritdoc />
    public void Configure(EntityTypeBuilder<AcknowledgmentResponseEntity> builder)
    {
