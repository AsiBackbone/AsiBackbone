...
/// <summary>
/// Configures the Entity Framework Core persistence mapping for <see cref="AcknowledgmentRequestEntity" />.
/// </summary>
public sealed class AcknowledgmentRequestEntityConfiguration
    : IEntityTypeConfiguration<AcknowledgmentRequestEntity>
{
    ...
    /// <inheritdoc />
    public void Configure(EntityTypeBuilder<AcknowledgmentRequestEntity> builder)
    {
