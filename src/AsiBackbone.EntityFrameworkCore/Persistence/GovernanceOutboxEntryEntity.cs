...
public sealed class GovernanceOutboxEntryEntity : GovernanceEntity
{
    ...
    /// </summary>
    public string EnvelopeSchemaVersion { get; set; } = GovernanceSchemaVersions.StableArtifactsV1;
    ...
    /// </summary>
    public DecisionReceiptLifecycleStage? EnvelopeLifecycleStage { get; set; }
