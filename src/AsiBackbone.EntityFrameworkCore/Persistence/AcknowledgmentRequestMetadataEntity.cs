...
/// </summary>
public sealed class AcknowledgmentRequestMetadataEntity : GovernanceEntity
{
    /// <summary>
    /// Gets or sets the identifier of the parent handshake request.
    /// </summary>
    public Guid AcknowledgmentRequestId { get; set; }
    ...
    /// </summary>
    public AcknowledgmentRequestEntity AcknowledgmentRequest { get; set; } = null!;
}
